...
export default function FootballLogo({ className, style }: FootballLogoProps) {
  ...
  <defs>
    ...
    <g id="c" strokeLinejoin="round" clipPath="url(#a)">
  ...
  <use xlinkHref="#c" stroke="#EEE" strokeWidth="7"/>
  <use xlinkHref="#c" stroke="#DDD" strokeWidth="4"/>
  <use xlinkHref="#c" stroke="#999" strokeWidth="2"/>
  <use xlinkHref="#c" stroke="#000"/>
